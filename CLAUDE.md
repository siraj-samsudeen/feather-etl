...
1. Read the review doc.  Every finding has a severity, file, and suggested fix.
2. Create `docs/plans/YYYY-MM-DD-<slice>-fixes.md` scoping what you will and
...
4. All tests use real DuckDB fixtures, no mocking.  See fixture table in
   `.claude/rules/feather-etl-project.md`.
